...
public class OrangeHRMLogin 
{
	...
	public void login(String userName,String password)
	{
		try
		{
			...
			fout=new FileOutputStream(new File("E:\\\\JavaProgrammes\\\\WebApplication\\\\src\\\\com\\\\ExcellData\\\\Data_asign.xlsx"));
			workBook.write(fout);
		}
		catch(Exception e)
		{
	...
	public void getLoginData()
	{
		try 
		{
			fin=new FileInputStream(new File("E:\\\\\\\\JavaProgrammes\\\\\\\\WebApplication\\\\\\\\src\\\\\\\\com\\\\\\\\ExcellData\\\\\\\\Data_asign.xlsx"));
	...
	{
		new OrangeHRMLogin().getLoginData();
	}
}
